...
public class UserController {
    ...
    public ResponseEntity<? extends BaseResponseBody> register(@Valid @RequestBody @ApiParam(value = "회원가입 정보", required = true) UserRegisterPostReq registerInfo) {
        try {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 401, message = "인증 실패"), @ApiResponse(code = 404, message = "사용자 없음"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<? extends BaseResponseBody> setInfo(@ApiIgnore Authentication authentication, @Valid @RequestBody @ApiParam(value = "회원수정 정보", required = true) UserSetInfoPostReq userSetInfoPostReq) {
        SsafyUserDetails userDetails = (SsafyUserDetails) authentication.getDetails();
        User user = userDetails.getUser();
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 404, message = "사용자 없음"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<UserFindIdRes> findId(@RequestBody @ApiParam(value = "회원 이름, 전화번호", required = true) UserFindIdReq req) {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 404, message = "사용자 없음"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<UserFindPwRes> findPw(@RequestBody @ApiParam(value = "회원 아이디", required = true) UserFindPwReq req) {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<? extends BaseResponseBody> changeNick(@ApiIgnore Authentication authentication, @RequestBody @ApiParam(value = "변경할 닉네임", required = true) UserChangeNick req) {
        SsafyUserDetails userDetails = (SsafyUserDetails) authentication.getDetails();
        User user = userDetails.getUser();
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<? extends BaseResponseBody> changePhone(@ApiIgnore Authentication authentication, @RequestBody @ApiParam(value = "변경할 번호", required = true) UserChangePhone req) {
        SsafyUserDetails userDetails = (SsafyUserDetails) authentication.getDetails();
        User user = userDetails.getUser();
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "성공"), @ApiResponse(code = 401, message = "인증 실패"), @ApiResponse(code = 404, message = "사용자 없음"), @ApiResponse(code = 500, message = "서버 오류")})
    public ResponseEntity<? extends BaseResponseBody> chekPw(@ApiIgnore Authentication authentication, @Valid @RequestBody @ApiParam(value = "비밀번호", required = true) UserCheckPwReq userCheckPwReq) {
        SsafyUserDetails userDetails = (SsafyUserDetails) authentication.getDetails();
        User user = userDetails.getUser();
